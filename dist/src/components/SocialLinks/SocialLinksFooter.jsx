...
exports.default = SocialLinksFooter;
...
function SocialLinksFooter({ siteInformationData }) {
    return (<div className="flex justify-center items-center">
      {siteInformationData?.facebook_url && (<link_1.default type="button" href={`https://${siteInformationData?.facebook_url ?? "www.facebook.com"}`} className="me-2" target="_blank">
          <button className="btn btn-circle bg-red-600 shadow-none hover:bg-black border-0 text-white btn-sm">
