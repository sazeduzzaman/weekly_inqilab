...
function MobileMenu({ categoryItems }) {
    ...
    return (<div>
      <div className="drawer drawer-end z-50 ">
        ...
        <div className="drawer-content hidden md:block desktop-triger">
          <label htmlFor="my-drawer-4" className="drawer-button bg-black btn btn-black px-5 py-3 search-menu">
        ...
        <div className="block md:hidden mobile-triger">
          <label htmlFor="my-drawer-4" className="drawer-button bg-black btn btn-black px-3 py-3 rounded-2">
            <ri_1.RiMenuSearchLine color="red" size={20}/>
          </label>
        </div>
