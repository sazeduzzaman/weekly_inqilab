...
const PolicyPage = () => {
    ...
    return (<div className="container mx-auto px-4 py-10 bg-white text-gray-900">
      {/* Tabs */}
      <div className="flex items-center justify-center border-b border-gray-300 mb-6">
        <button className={`px-4 py-2 text-sm font-medium cursor-grab ${activeTab === "bangla"
            ? "border-b-2 border-indigo-600 text-indigo-600"
            : "text-gray-500 hover:text-indigo-500"}`} onClick={() => setActiveTab("bangla")}>
          বাংলায় পড়ুন
        </button>
        <button className={`ml-4 px-4 py-2 text-sm font-medium cursor-grab ${activeTab === "english"
            ? "border-b-2 border-indigo-600 text-indigo-600"
