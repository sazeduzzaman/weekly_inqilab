...
const MobileMenu_1 = __importDefault(require("@/components/SearchDropdown/MobileMenu"));
async function CenterBar() {
    const categoryItems = await (0, CategoryDataSet_1.CategoryDataSet)();
    const advertisementTopRight = await (0, Advertisment_1.Advertisment)();
    const siteInformationData = await (0, SiteInformation_1.SiteInformation)();
    return (<div className=" bg-white shadow-sm w-full">
      <div className="container mx-auto">
        ...
        >
          ...
          >
            ...
            <MobileMenu_1.default categoryItems={categoryItems}/>
          ...
          <div className="navbar-center flex w-full sm:w-[20%] justify-center d-sm-none pr-3">
            ...
            <div className="ms-3">
              <link_1.default href="/epaper" className="btn btn-black bg-black px-5 py-3 search-menu">
          ...
          <div className="navbar-end flex w-full sm:w-[60%] justify-end d-sm-none">
            ...
            advertisementTopRight.some((ad) => ad.position === "header_right") ? (<Advertisement_1.default advertisements={advertisementTopRight} position="header_right" availability="available" marginB={10}/>) : (<div>
                <image_1.default src="/images/ads-768x71.webp" alt="Inqilab Logo" width={915} height={400}/>
              </div>)}
          </div>
        </div>
      </div>
