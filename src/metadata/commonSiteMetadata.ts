export const commonSiteMetadata = {
  title: "Weekly Inqilab",
  description:
    "Weekly Inqilab offers the latest news, breaking stories, and insightful articles on politics, culture, entertainment, and more. Stay informed with the latest updates every week.",
  author: "Weekly Inqilab Editorial Team",
  keywords:
    "news, Weekly Inqilab, latest news, breaking news, politics, entertainment, world news, technology, sports, local news, weekly newspaper",
  ...
  openGraph: {
    ...
    description:
      "Weekly Inqilab delivers the latest breaking news and insightful articles on various topics including politics, culture, sports, and more.", // Open Graph description
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Catch up with the latest news, articles, and breaking headlines on Weekly Inqilab.", // Twitter description
