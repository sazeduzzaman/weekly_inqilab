...
const SaradeshNews = () => {
    return (<div>
      {newsData.map((item, index) => (<div key={index} className="card rounded-none card-side shadow-sm items-center mb-3">
          <figure className="relative w-[150px] h-[135px] flex-none">
            <image_1.default src={item.image} alt="News Thumbnail" fill className="object-cover" priority/>
          </figure>
